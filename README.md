...
- 单张 / 三张（过去 · 现在 · 未来）/ 本周（主线 · 注意 · 行动）/ 关系（我 · 他 · 我们之间 · 阻碍 · 走向）
...
解读文案正在从「按主题一段」升级成「牌名 + 正逆位 + 主题 + 牌位」一格一段：普通牌位 78 × 2 × 4 主题 × 8 牌位（单张、每日、本周主线、需要注意、行动建议、过去、现在、未来）= 4992 格，关系牌阵不叠主题 78 × 2 × 5 = 780 格，共 5772 格。结构、键名、进度工具见 `data/library/README.md`。没写的格自动退回老表，填一格生效一格。
